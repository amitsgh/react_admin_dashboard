...
const OverviewChart = ({ isDashboard = false, view }) => {
    ...
    monthlyData.forEach(({ month, totalSales, totalUnits }) => {
        const curSales =
            totalSalesLine.data.length > 0
                ? totalSalesLine.data[totalSalesLine.data.length - 1].y +
                  totalSales
                : totalSales;
        const curUnits =
            totalUnitsLine.data.length > 0
                ? totalUnitsLine.data[totalUnitsLine.data.length - 1].y +
                  totalUnits
                : totalUnits;
